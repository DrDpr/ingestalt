            ...
            >
                ...
                {options ? (
                    ...
                    <input
                        ...
                        className="w-full px-4 py-3 bg-background border border-border text-foreground/80 text-sm focus:outline-none focus:border-blue-500 rounded-lg transition-all mb-6"
